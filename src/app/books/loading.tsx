  ...
  return (
    <div className="space-y-6 animate-pulse w-full">
      ...
      <div className="space-y-2 pb-4 border-b border-paper-300 dark:border-charcoal-300">
        <div className="h-8 w-44 bg-paper-300 dark:bg-charcoal-300 rounded-lg"></div>
        <div className="h-4 w-64 bg-paper-200 dark:bg-charcoal-50 rounded"></div>
      </div>

      {/* Search & Filter Skeleton */}
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="h-11 flex-1 bg-paper-200 dark:bg-charcoal-300 rounded-xl border border-paper-300 dark:border-charcoal-50"></div>
        <div className="h-11 w-36 bg-paper-200 dark:bg-charcoal-300 rounded-xl border border-paper-300 dark:border-charcoal-50"></div>
        <div className="h-11 w-36 bg-paper-200 dark:bg-charcoal-300 rounded-xl border border-paper-300 dark:border-charcoal-50"></div>
      </div>
